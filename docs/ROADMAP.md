...
- continue extracting `repo_privacy_guardian/core.py` by remediation and CLI/config domains without breaking compatibility shims; redaction, tooling, reporting, policy, scanner, GUI app, and GUI locale already use explicit dependencies or local constants
