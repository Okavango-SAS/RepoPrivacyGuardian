...
![Repo Privacy Guardian release readiness banner](docs/assets/repo-privacy-guardian-banner.jpg)
...
- `v1.4.3` is the current patch release with GUI parity and agentic publication readiness hardening.
