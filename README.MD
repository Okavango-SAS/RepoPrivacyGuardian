...
| Prepare a release | [OPERATIONS](docs/OPERATIONS.md), [RELEASE_CHECKLIST](docs/RELEASE_CHECKLIST.md), then `python scripts/release_readiness.py` | Release-readiness gates and recovery notes |
