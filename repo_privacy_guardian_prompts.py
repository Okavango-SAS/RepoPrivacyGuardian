...
PROMPT_REGISTRY: tuple[AgenticPrompt, ...] = (
    ...
    AgenticPrompt(
        ...
        description="Usar despues de clonar Repo Privacy Guardian para instalar el paquete y verificar tooling sin auditar otros repositorios.",
    ...
    AgenticPrompt(
        ...
        description="Ejecutar una pasada audit-only defensiva, clasificar hallazgos y preservar evidencia redactada antes de cualquier reparacion.",
    ...
    AgenticPrompt(
        prompt_id="audit_and_repair",
        locale="es-419",
        title="Auditar y reparar con aprobacion",
        description="Usar cuando el operador ya reviso hallazgos y quiere que un agente previsualice, aplique fixes aprobados y re-audite.",
    ...
    AgenticPrompt(
        prompt_id="cli_workflow",
        locale="es-419",
        title="Flujo CLI agentico",
        description="Prompt compacto para delegar un flujo CLI release/security en Codex, Claude Code, Cursor, GitHub Copilot, Antigravity o herramientas similares.",
