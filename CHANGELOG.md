...
- Reduced compatibility-bridge coupling in the redaction, tooling, reporting, scanner/remediation, and GUI app modules by replacing broad core star imports with explicit dependencies while preserving public facades.
